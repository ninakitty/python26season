            ...
            while True:
                ...
                if account < total_price:
                    ...
                    if del_goods.isdigit():
                        ...
                        print(shop_cart[del_goods]['amount'])
                        if shop_cart[del_goods]['amount'] > 1 :
                            shop_cart[del_goods]['amount'] -= 1
                        else:
                    ...
                    print('购买成功')
                    print('本次消费：{} 元，余额：{};输入q退出程序！'.format(total_price,account-total_price))
                    break
        elif buy == 'q':
            break
        else:
